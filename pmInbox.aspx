<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="pmInbox.aspx.cs" Inherits="PrivateMessages" Title="DiveIntoThePool.com" EnableEventValidation="false" Trace="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="navContainer">
        <ul class="navlist">
            <li><a class="currentPage">Inbox</a></li>
            <li><a href="pmSent.aspx">Sent Items</a></li>
            <li><a href="pmSend.aspx">Send Private Message</a></li>
        </ul>
    </div>
    <div class="pmControls">
        <asp:Button ID="DeleteButton" runat="server" Text="Delete" OnClick="DeleteMessagesFrom_Inbox" />
