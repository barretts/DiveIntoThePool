<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" Trace="false" AutoEventWireup="true" CodeFile="SearchProfiles.aspx.cs" Inherits="SearchProfiles" Title="DiveIntoThePool.com" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:DropDownList ID="ArrangeBy" runat="server">
        <asp:ListItem Value="lastVisit">Recently Active</asp:ListItem>
        <asp:ListItem Value="newestMembers">Newest Members</asp:ListItem>
        <asp:ListItem Value="distanceFrom">Distance</asp:ListItem>
    </asp:DropDownList>
